...
bot_token = '7239127558:AAF72JGUUhD6SoYOjTE6GTAZogy4RuftK_I'
bot = telebot.TeleBot(bot_token)
user_data = {}
allowed_users = ['1633002063']
admin_id = '1633002063'
subscription_data = {}
...
def start(message):
    ...
    if user_id in allowed_users:
        ...
        bot.reply_to(message, 'انت غير مشترك في البوت للاشتراك @x99g9')
...
def show_admin_commands(message):
    if str(message.from_user.id) == '1633002063':  
